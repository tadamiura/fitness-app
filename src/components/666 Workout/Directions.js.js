...
const Directions = () => {
    return (
        <div>
            ...
            <p>Réaliser <span className='bold uppercase'>6 séries</span> de <span className='bold uppercase'>6 répétitions</span> du premier exercice puis <span className='bold uppercase'>6 répétitions</span> du second</p>
